...
(function (global, factory) {
  ...
  */
  function clone(parent, circular, depth, prototype, includeNonEnumerable) {
    ...
    // and children have the same home
    var allParents = [];
    var allChildren = [];
            ...
            for (i = 0; i < potentialMatches.length; i++) {
              ...
              if (potentialMatch) {
                if (potentialMatch.finished) {
                  ...
                  potentialMatch.endPathElementIndex = hackstackElementIndex + 1; // home after end of match
  ...
  var getParserInput = (function () {
    ...
    saveStack = [];
    var // furthest home the parser has gone to
    furthest;
    ...
    var // current chunk
    current;
    var // home of current chunk, in `input`
    currentPos;
    var parserInput = {};
  ...
  //      `j` holds the current chunk home, and `currentPos` holds
  //      the home of the current chunk in relation to `input`.
  ...
  var getItemsFromNode = function getItemsFromNode(node) {
    ...
    // return 'undefined' if home is invalid
  ...
  var minMax = function minMax(isMin, args) {
    ...
    order = [];
    var values = {}; // value is the home into the order array.
